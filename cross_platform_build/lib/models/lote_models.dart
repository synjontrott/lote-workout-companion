  ...
  String dynamicDisplayName(String elementName) {
    switch (elementName) {
      case 'Fire':
        switch (this) {
          case WarriorTier.recruit:
            return "Ember Recruit";
          case WarriorTier.apprentice:
            return "Flame Apprentice";
          case WarriorTier.vanguard:
            return "Cinder Vanguard";
          case WarriorTier.sentinel:
            return "Blaze Sentinel";
          case WarriorTier.master:
            return "Inferno Master";
          case WarriorTier.legend:
            return "Legend of the Phoenix";
          case WarriorTier.champion:
            return "Molten Warchief";
          case WarriorTier.sovereign:
            return "Volcanic Imperator";
          case WarriorTier.mythic:
            return "Supernova Destroyer";
      ...
      case 'Water':
        switch (this) {
          case WarriorTier.recruit:
            return "Tide Recruit";
          case WarriorTier.apprentice:
            return "Hydro Apprentice";
          case WarriorTier.vanguard:
            return "Torrent Vanguard";
          case WarriorTier.sentinel:
            return "Wave Sentinel";
          case WarriorTier.master:
            return "Abyss Master";
          case WarriorTier.legend:
            return "Legend of the Ocean";
          case WarriorTier.champion:
            return "Tide Breaker";
          case WarriorTier.sovereign:
            return "Abyss Lord";
          case WarriorTier.mythic:
            return "Ocean Legend";
          case WarriorTier.transcendent:
            return "Hydro Sovereign";
        }
      case 'Earth':
        switch (this) {
          case WarriorTier.recruit:
            return "Stone Recruit";
          case WarriorTier.apprentice:
            return "Clay Apprentice";
          case WarriorTier.vanguard:
            return "Rock Vanguard";
          case WarriorTier.sentinel:
            return "Ridge Sentinel";
          case WarriorTier.master:
            return "Mountain Master";
          case WarriorTier.legend:
            return "Legend of the Golem";
          case WarriorTier.champion:
            return "Stone Warden";
          case WarriorTier.sovereign:
      ...
      case 'Air':
        switch (this) {
          case WarriorTier.recruit:
            return "Wind Recruit";
          case WarriorTier.apprentice:
            return "Gale Apprentice";
          case WarriorTier.vanguard:
            return "Zephyr Vanguard";
          case WarriorTier.sentinel:
            return "Vortex Sentinel";
          case WarriorTier.master:
            return "Tempest Master";
          case WarriorTier.legend:
            return "Legend of the Storm";
          case WarriorTier.champion:
            return "Wind Dancer";
          case WarriorTier.sovereign:
            return "Tempest Ruler";
          case WarriorTier.mythic:
            return "Storm Legend";
          case WarriorTier.transcendent:
            return "Vortex Master";
        }
      case 'Lightning':
        switch (this) {
          case WarriorTier.recruit:
            return "Spark Recruit";
          case WarriorTier.apprentice:
            return "Bolt Apprentice";
          case WarriorTier.vanguard:
            return "Shock Vanguard";
          case WarriorTier.sentinel:
            return "Storm Sentinel";
          case WarriorTier.master:
            return "Voltage Master";
          case WarriorTier.legend:
            return "Legend of Thunder";
          case WarriorTier.champion:
            return "Spark Runner";
          case WarriorTier.sovereign:
            return "Bolt Striker";
          case WarriorTier.mythic:
            return "Thunder Legend";
          case WarriorTier.transcendent:
            return "Voltage God";
        }
      case 'Metal':
        switch (this) {
          case WarriorTier.recruit:
            return "Iron Recruit";
          case WarriorTier.apprentice:
            return "Steel Apprentice";
          case WarriorTier.vanguard:
            return "Alloy Vanguard";
          case WarriorTier.sentinel:
            return "Shield Sentinel";
          case WarriorTier.master:
            return "Forge Master";
          case WarriorTier.legend:
            return "Legend of Titanium";
          case WarriorTier.champion:
            return "Iron Guard";
          case WarriorTier.sovereign:
            return "Steel Lord";
      ...
      case 'Ice':
        switch (this) {
          case WarriorTier.recruit:
            return "Frost Recruit";
          case WarriorTier.apprentice:
            return "Ice Apprentice";
          case WarriorTier.vanguard:
            return "Glacier Vanguard";
          case WarriorTier.sentinel:
            return "Shard Sentinel";
          case WarriorTier.master:
            return "Tundra Master";
          case WarriorTier.legend:
            return "Legend of Blizzard";
          case WarriorTier.champion:
            return "Glacial Warchief";
          case WarriorTier.sovereign:
            return "Blizzard Imperator";
          case WarriorTier.mythic:
            return "Arctic Annihilator";
          case WarriorTier.transcendent:
            return "Eternal Permafrost";
        }
      case 'Bone':
        switch (this) {
          case WarriorTier.recruit:
            return "Calcium Recruit";
          case WarriorTier.apprentice:
            return "Skeletal Apprentice";
          case WarriorTier.vanguard:
            return "Fossil Vanguard";
          case WarriorTier.sentinel:
            return "Marrow Sentinel";
          case WarriorTier.master:
            return "Crypt Master";
          case WarriorTier.legend:
            return "Legend of the Grave";
          case WarriorTier.champion:
            return "Skeletal Knight";
          case WarriorTier.sovereign:
            return "Crypt Walker";
          case WarriorTier.mythic:
            return "Grave Legend";
      ...
      case 'Gas':
        switch (this) {
          case WarriorTier.recruit:
            return "Vapor Recruit";
          case WarriorTier.apprentice:
            return "Mist Apprentice";
          case WarriorTier.vanguard:
            return "Cloud Vanguard";
          case WarriorTier.sentinel:
            return "Fume Sentinel";
          case WarriorTier.master:
            return "Plasma Master";
          case WarriorTier.legend:
            return "Legend of Atmosphere";
          case WarriorTier.champion:
            return "Mist Weaver";
          case WarriorTier.sovereign:
            return "Cloud Ruler";
          case WarriorTier.mythic:
            return "Atmosphere Legend";
          case WarriorTier.transcendent:
            return "Plasma Lord";
        }
      case 'Laser':
        switch (this) {
          case WarriorTier.recruit:
            return "Ray Recruit";
          case WarriorTier.apprentice:
            return "Beam Apprentice";
          case WarriorTier.vanguard:
            return "Pulse Vanguard";
          case WarriorTier.sentinel:
            return "Focus Sentinel";
          case WarriorTier.master:
            return "Photon Master";
          case WarriorTier.legend:
            return "Legend of the Cosmos";
          case WarriorTier.champion:
            return "Ray Caster";
          case WarriorTier.sovereign:
            return "Beam Master";
          case WarriorTier.mythic:
            return "Cosmos Legend";
          case WarriorTier.transcendent:
            return "Photon God";
        }
      case 'Zero Space':
        switch (this) {
          case WarriorTier.recruit:
            return "Node Recruit";
          case WarriorTier.apprentice:
            return "Rift Apprentice";
          case WarriorTier.vanguard:
            return "Warp Vanguard";
          case WarriorTier.sentinel:
            return "Gate Sentinel";
          case WarriorTier.master:
            return "Singularity Master";
          case WarriorTier.legend:
            return "Legend of the Void";
          case WarriorTier.champion:
            return "Rift Walker";
          case WarriorTier.sovereign:
            return "Warp Lord";
      ...
      case 'Darki':
        switch (this) {
          case WarriorTier.recruit:
            return "Dark Recruit";
          case WarriorTier.apprentice:
            return "Shade Apprentice";
          case WarriorTier.vanguard:
            return "Night Vanguard";
          case WarriorTier.sentinel:
            return "Royal Sentinel";
          case WarriorTier.master:
            return "Sovereign Master";
          case WarriorTier.legend:
            return "Legend of Eclipse";
          case WarriorTier.champion:
            return "Shade Hunter";
          case WarriorTier.sovereign:
            return "Night Sovereign";
          case WarriorTier.mythic:
            return "Eclipse Legend";
          case WarriorTier.transcendent:
            return "Royal Shadow";
        }
      case 'Death':
        switch (this) {
          case WarriorTier.recruit:
            return "Wither Recruit";
          case WarriorTier.apprentice:
            return "Decay Apprentice";
          case WarriorTier.vanguard:
            return "Reaper Vanguard";
          case WarriorTier.sentinel:
            return "Soul Sentinel";
          case WarriorTier.master:
            return "Crypt Master";
          case WarriorTier.legend:
            return "Legend of Doom";
          case WarriorTier.champion:
            return "Wither Touch";
          case WarriorTier.sovereign:
            return "Reaper Lord";
      ...
      case 'Knife':
        switch (this) {
          case WarriorTier.recruit:
            return "Edge Recruit";
          case WarriorTier.apprentice:
            return "Blade Apprentice";
          case WarriorTier.vanguard:
            return "Dagger Vanguard";
          case WarriorTier.sentinel:
            return "Pierce Sentinel";
          case WarriorTier.master:
            return "Saber Master";
          case WarriorTier.legend:
            return "Legend of the Sword";
          case WarriorTier.champion:
            return "Edge Master";
          case WarriorTier.sovereign:
            return "Blade Sovereign";
          case WarriorTier.mythic:
            return "Sword Legend";
          case WarriorTier.transcendent:
            return "Pierce God";
      ...
      case 'Poison':
        switch (this) {
          case WarriorTier.recruit:
            return "Venom Recruit";
          case WarriorTier.apprentice:
            return "Toxin Apprentice";
          case WarriorTier.vanguard:
            return "Viper Vanguard";
          case WarriorTier.sentinel:
            return "Acid Sentinel";
          case WarriorTier.master:
            return "Serum Master";
          case WarriorTier.legend:
            return "Legend of Plague";
          case WarriorTier.champion:
            return "Venom Spitter";
          case WarriorTier.sovereign:
            return "Toxin Lord";
          case WarriorTier.mythic:
            return "Plague Legend";
          case WarriorTier.transcendent:
            return "Acid King";
        }
      case 'Shadow':
        switch (this) {
          case WarriorTier.recruit:
            return "Shade Recruit";
          case WarriorTier.apprentice:
            return "Dusk Apprentice";
          case WarriorTier.vanguard:
            return "Veil Vanguard";
          case WarriorTier.sentinel:
            return "Phantom Sentinel";
          case WarriorTier.master:
            return "Eclipse Master";
          case WarriorTier.legend:
            return "Legend of the Ghost";
          case WarriorTier.champion:
            return "Veil Walker";
          case WarriorTier.sovereign:
            return "Phantom Lord";
...
class DNDStats {
  ...
  void decrease(StatType stat, int amount) {
    switch (stat) {
      case StatType.strength:
        strength = (strength - amount).clamp(1, 999);
        break;
      case StatType.dexterity:
        dexterity = (dexterity - amount).clamp(1, 999);
        break;
      case StatType.constitution:
        constitution = (constitution - amount).clamp(1, 999);
        break;
      case StatType.intelligence:
        intelligence = (intelligence - amount).clamp(1, 999);
        break;
      case StatType.wisdom:
        wisdom = (wisdom - amount).clamp(1, 999);
        break;
      case StatType.charisma:
        charisma = (charisma - amount).clamp(1, 999);
        break;
    }
  }
}
...
class CharacterSprite {
  ...
  CharacterSprite({
    ...
    List<List<int>>? grid,
           ...
           grid ??
           generateGrid(planet: outfitStyle, hairStyle: hairStyle, sex: sex);
  ...
  factory CharacterSprite.fromJson(Map<String, dynamic> json) {
    ...
    if (rawGrid != null) {
      final decoded = rawGrid
          .map(
            (row) => (row as List<dynamic>).map((cell) => cell as int).toList(),
          )
          .toList();
      if (decoded.length < 300 ||
          (decoded.isNotEmpty && decoded[0].length < 300)) {
  ...
  static List<List<int>> scale16To300(List<List<int>> grid16) {
    List<List<int>> grid300 = List.generate(
      300,
      (_) => List.generate(300, (_) => 0),
    );
    for (int r = 0; r < 300; r++) {
      for (int c = 0; c < 300; c++) {
        int r16 = (r * 16) ~/ 300;
  ...
  static List<List<int>> generateGrid({
    ...
    if (planet == "Warrion") {
      ...
      for (int r = startRow; r <= endRow; r++) {
        ...
        final halfWidth =
            baseHalfW - pct * (baseHalfW - waistHalfW) + segmentOffset;
      ...
      for (int r = 165; r <= 185; r++) {
        ...
        const ventREnd = 190;
        for (int c = ventLStart; c <= ventLEnd; c++) {
          grid[r][c] = 5;
        }
        for (int c = ventRStart; c <= ventREnd; c++) {
          grid[r][c] = 5;
        }
      }
    } else {
    ...
    for (int r = 160; r <= 250; r++) {
      ...
      if (isFemale) {
        final leftCenter =
            (150.0 - shoulderHalfW + 4.0 - math.sin(pct * math.pi) * 4.0)
                .toInt();
        final rightCenter =
            (150.0 + shoulderHalfW - 4.0 + math.sin(pct * math.pi) * 4.0)
                .toInt();
        for (int c = (leftCenter - 6); c <= (leftCenter + 6); c++) {
          grid[r][c] = 4;
        }
        for (int c = (rightCenter - 6); c <= (rightCenter + 6); c++) {
          grid[r][c] = 4;
        }
        if (planet == "Techno") {
          grid[r][leftCenter] = 5;
        ...
        final leftCenter =
            (150.0 - shoulderHalfW + 8.0 - math.sin(pct * math.pi) * 6.0)
                .toInt();
        final rightCenter =
            (150.0 + shoulderHalfW - 8.0 + math.sin(pct * math.pi) * 6.0)
                .toInt();
        for (int c = (leftCenter - 10); c <= (leftCenter + 10); c++) {
          grid[r][c] = 4;
        }
        for (int c = (rightCenter - 10); c <= (rightCenter + 10); c++) {
          grid[r][c] = 4;
        }
        if (planet == "Techno") {
          grid[r][leftCenter] = 5;
    ...
    if (isFemale) {
      ...
      if (planet == "Techno" || planet == "Dark Laser") {
        ...
        for (int r = 94; r <= 98; r++) {
          for (int c = 134; c <= 142; c++) {
            grid[r][c] = 3;
          }
        }
        for (int r = 94; r <= 98; r++) {
          for (int c = 158; c <= 166; c++) {
            grid[r][c] = 3;
          }
        }
        for (int c = 130; c <= 144; c++) {
          grid[90][c] = 2;
        }
        for (int c = 160; c <= 176; c++) {
          grid[90][c] = 2;
        }
      }
      // Lip line for female
      for (int c = 146; c <= 154; c++) {
        grid[116][c] = 4;
      }
    } else {
      // Male Hooded Mask
    ...
    for (int r = 80; r <= 124; r++) {
      for (int c = 112; c <= 120; c++) {
        grid[r][c] = 2;
      }
      for (int c = 180; c <= 188; c++) {
        grid[r][c] = 2;
      }
      if (r >= 88 && r <= 108) {
        grid[r][121] = 2;
    ...
    if (hairStyle == "Spiky") {
      for (int r = 20; r <= 60; r++) {
        for (int c = 120; c <= 180; c++) {
          final cOffset = c - 150;
          if (cOffset.abs() <= 6 && r >= 20 + cOffset.abs() * 4) {
            grid[r][c] = 2;
          }
          if (cOffset >= 15 &&
              cOffset <= 30 &&
              r >= 32 + (cOffset - 22).abs() * 3) {
            grid[r][c] = 2;
          }
          if (cOffset <= -15 &&
              cOffset >= -30 &&
      ...
      for (int r = 50; r <= 85; r++) {
        for (int c = 96; c <= 204; c++) {
          if (c < 116 && r >= 85 - (c - 96) * 2) {
            grid[r][c] = 2;
          }
          if (c > 184 && r >= 85 - (204 - c) * 2) {
            grid[r][c] = 2;
          }
        }
      }
      ...
      for (int r = 80; r <= 220; r++) {
        ...
        for (int c = (98 + waveL.toInt()); c <= (106 + waveL.toInt()); c++) {
          grid[r][c] = 2;
        }
        for (int c = (194 + waveR.toInt()); c <= (202 + waveR.toInt()); c++) {
          grid[r][c] = 2;
        }
      }
    ...
    for (int r = 252; r <= 290; r++) {
      ...
      for (int c = (legLOffset - legHalfW); c <= (legLOffset + legHalfW); c++) {
        grid[r][c] = 4;
      }
      for (int c = (legROffset - legHalfW); c <= (legROffset + legHalfW); c++) {
        grid[r][c] = 4;
      }
    }
    for (int r = 291; r <= 299; r++) {
      ...
      for (
        int c = (bootLOffset - bootHalfW);
        c <= (bootLOffset + bootHalfW);
        c++
      ) {
        grid[r][c] = 4;
      }
      for (
        int c = (bootROffset - bootHalfW);
        c <= (bootROffset + bootHalfW);
        c++
      ) {
        grid[r][c] = 4;
      }
...
class ShopItem {
  ...
  final String description;
  final String
  type; // "frame", "title", "aura", "background", "accessory", "stat", "badge"
  ...
  static List<ShopItem> get availableItems => [
    ...
    ShopItem(
      ...
      cost: 150,
      description:
          "A fiery red profile border that radiates internal warmth and volcanic energy.",
      type: "frame",
      sprite: "🔥",
    ),
    ShopItem(
      name: "Crystalline Frame",
      cost: 180,
      description:
          "Teal frost profile border composed of compressed, unbreakable ice particles.",
      type: "frame",
      sprite: "❄️",
    ),
    ShopItem(
      ...
      cost: 220,
      description:
          "Deep shadow profile border that absorbs surrounding ambient light.",
      type: "frame",
      sprite: "⬛",
    ),
    ShopItem(
      ...
      cost: 250,
      description:
          "Neon blue glowing profile border simulating a retro digital grid structure.",
      type: "frame",
      sprite: "🌀",
    ),
    // Titles
    ShopItem(
      ...
      cost: 200,
      description:
          "Exotic warrior status title reserved for those who have quieted the mind's static.",
      type: "title",
      sprite: "👑",
    ),
    ShopItem(
      ...
      cost: 300,
      description:
          "Immortal warrior status title denoting timeless discipline and grit.",
      type: "title",
      sprite: "⏳",
    ),
    ShopItem(
      name: "Elsaither Vanguard",
      cost: 150,
      description:
          "Elite vanguard title honoring high dedication to the Elsaither realms.",
      type: "title",
      sprite: "🛡️",
    ),
    ShopItem(
      ...
      cost: 180,
      description:
          "Master smith title representing patience, heavy lifting, and raw creation.",
      type: "title",
      sprite: "🔨",
    ),
    // Auras
    ShopItem(
      ...
      cost: 300,
      description:
          "Cybernetic glowing aura animation effect that flickers with static electricity.",
      type: "aura",
      sprite: "⚡",
    ),
    ShopItem(
      ...
      cost: 400,
      description:
          "Fiery wings rising aura effect representing constant recovery and rebirth.",
      type: "aura",
      sprite: "🦅",
    ),
    ShopItem(
      ...
      cost: 350,
      description:
          "Shadowy dark tendrils aura effect that wraps your avatar in mysterious fog.",
      type: "aura",
      sprite: "🌫️",
    ),
    ShopItem(
      ...
      cost: 320,
      description:
          "Electric storm discharge aura effect that crackles with raw kinetic energy.",
      type: "aura",
      sprite: "🌩️",
    ),
    // Backgrounds
    ShopItem(
      name: "Neon Cyber Space",
      cost: 250,
      description: "Cyberpunk neon grid backdrop casting vibrant violet hues.",
      type: "background",
      sprite: "🌃",
    ),
    ShopItem(
      name: "Nebula Starfield",
      cost: 300,
      description:
          "Deep space cosmic dust overlay featuring shimmering alien constellations.",
      type: "background",
      sprite: "🌌",
    ),
    ShopItem(
      ...
      cost: 350,
      description:
          "Molten fire cavern backdrop pulsing with geothermal streams.",
      type: "background",
      sprite: "🌋",
    ),
    ShopItem(
      ...
      cost: 200,
      description:
          "Serene meditation backdrop with raked gravel and bamboo stalks.",
      type: "background",
      sprite: "🎋",
    ),
    ...
    ShopItem(
      ...
      cost: 150,
      description:
          "Heavy royal shoulder guards crafted from pure gold that increase presence.",
      type: "accessory",
      sprite: "🎗️",
    ),
    ShopItem(
      ...
      cost: 250,
      description:
          "Massive element-infused blade capable of cleaving mountains.",
      type: "accessory",
      sprite: "⚔️",
    ),
    ShopItem(
      ...
      cost: 200,
      description:
          "Glowing red tactical eyepiece that tracks muscle load and recovery times.",
      type: "accessory",
      sprite: "🕶️",
    ),
    ShopItem(
      name: "Elsaither Wings",
      cost: 400,
      description:
          "Hovering mechanical energy wings that grant elevated mobility.",
      type: "accessory",
      sprite: "👼",
    ),
    // Stats
    ShopItem(
      name: "Strength Elixir (+1 STR)",
      cost: 500,
      description:
          "Permanently boost your Strength by 1 point, enhancing lifting capacity.",
      type: "stat",
      sprite: "🧪",
    ),
    ShopItem(
      name: "Gale Boots (+1 DEX)",
      cost: 500,
      description:
          "Permanently boost your Dexterity by 1 point, enhancing agility.",
      type: "stat",
      sprite: "🥾",
    ),
    ShopItem(
      name: "Marrow Brew (+1 CON)",
      cost: 500,
      description:
          "Permanently boost your Constitution by 1 point, enhancing physical endurance.",
      type: "stat",
      sprite: "🍺",
    ),
    ShopItem(
      name: "Mind Stone (+1 INT)",
      cost: 500,
      description:
          "Permanently boost your Intelligence by 1 point, enhancing puzzle solving.",
      type: "stat",
      sprite: "💎",
    ),
    ShopItem(
      name: "Wisdom Herb (+1 WIS)",
      cost: 500,
      description:
          "Permanently boost your Wisdom by 1 point, enhancing awareness.",
      type: "stat",
      sprite: "🌿",
    ),
    ShopItem(
      name: "Crown of Command (+1 CHA)",
      cost: 500,
      description:
          "Permanently boost your Charisma by 1 point, enhancing social influence.",
      type: "stat",
      sprite: "👑",
    ),
    // Badges
    ShopItem(
      name: "Celestial Dragon Badge",
      cost: 200,
      description:
          "Unlocks the special celestial dragon profile badge indicating elite status.",
      type: "badge",
      sprite: "🐉",
    ),
  ];
...
class FitnessBadge {
  ...
  static List<FitnessBadge> get allBadges => [
    ...
    FitnessBadge(
      name: "Flame Starter",
      description: "Unlock 5 fitness challenges or quests",
      iconName: "local_fire_department",
    ),
    FitnessBadge(
      name: "Lore Scholar",
      description: "Complete the initial psychological evaluations",
      iconName: "psychology",
    ),
    FitnessBadge(
      name: "Weight Target Achieved",
      description: "Successfully reach your target weight goal",
      iconName: "verified",
    ),
    FitnessBadge(
      name: "Streak Master",
      description: "Achieve a consecutive 7-day streak of workouts",
      iconName: "emoji_events",
    ),
    FitnessBadge(
      name: "Guild Patron",
      description: "Buy your first stat elixir or cosmetic from the shop",
      iconName: "shopping_cart",
    ),
    FitnessBadge(
      name: "Demi-God",
      description: "Achieve an Attribute level of 18 or higher in any stat",
      iconName: "star",
    ),
    // Stretch goals
    FitnessBadge(
      name: "20k Steps Sentinel",
      description: "Walk 20,000 steps in a single day",
      iconName: "directions_run",
    ),
    FitnessBadge(
      name: "Iron Will (1 Hr)",
      description: "Complete a 1-hour active workout",
      iconName: "timer",
    ),
    FitnessBadge(
      name: "Unstoppable Force (2 Hr)",
      description: "Complete a 2-hour active workout",
      iconName: "alarm",
    ),
    FitnessBadge(
      name: "Quest Crusader (100 Quests)",
      description: "Complete 100 fitness quests",
      iconName: "assignment_turned_in",
    ),
    FitnessBadge(
      name: "Legendary Champion (1000 Quests)",
      description: "Complete 1000 fitness quests",
      iconName: "military_tech",
    ),
    FitnessBadge(
      name: "Vanguard Streak (14 Days)",
      description: "Achieve a consecutive 14-day workout streak",
      iconName: "whatshot",
    ),
    FitnessBadge(
      name: "Sovereign Streak (30 Days)",
      description: "Achieve a consecutive 30-day workout streak",
      iconName: "workspace_premium",
    ),
    FitnessBadge(
      name: "Immortal Streak (100 Days)",
      description: "Achieve a consecutive 100-day workout streak",
      iconName: "workspace_premium",
    ),
    // Monthly Challenges Badges
    FitnessBadge(
      name: "January Resolution Badge",
      description: "Complete the January challenge: Do 1,000 Pushups",
      iconName: "check_circle",
    ),
    FitnessBadge(
      name: "February Cardio Badge",
      description:
          "Complete the February challenge: Perform 300 minutes of Cardio",
      iconName: "directions_run",
    ),
    FitnessBadge(
      name: "March Flexibility Badge",
      description:
          "Complete the March challenge: Perform 120 minutes of Yoga/Flexibility",
      iconName: "accessibility_new",
    ),
    FitnessBadge(
      name: "April Hydration Badge",
      description: "Complete the April challenge: Drink 90 Liters of water",
      iconName: "water_drop",
    ),
    FitnessBadge(
      name: "May Walkabout Badge",
      description: "Complete the May challenge: Walk 50 miles",
      iconName: "directions_walk",
    ),
    FitnessBadge(
      name: "June Strength Badge",
      description:
          "Complete the June challenge: Complete 20 Strength Forge workouts",
      iconName: "fitness_center",
    ),
    FitnessBadge(
      name: "July Zen Badge",
      description:
          "Complete the July challenge: Perform 150 minutes of Meditation",
      iconName: "self_improvement",
    ),
    FitnessBadge(
      name: "August Hydration Badge",
      description: "Complete the August challenge: Drink 100 Liters of water",
      iconName: "opacity",
    ),
    FitnessBadge(
      name: "September Steps Badge",
      description: "Complete the September challenge: Log 250,000 steps",
      iconName: "run_circle",
    ),
    FitnessBadge(
      name: "October Squats Badge",
      description: "Complete the October challenge: Do 1,200 Squats",
      iconName: "sports_martial_arts",
    ),
    FitnessBadge(
      name: "November Flexibility Badge",
      description:
          "Complete the November challenge: Complete 15 Flexibility sessions",
      iconName: "airline_seat_recline_extra",
    ),
    FitnessBadge(
      name: "December Quests Badge",
      description: "Complete the December challenge: Complete 40 Daily Quests",
      iconName: "stars",
    ),
  ];
}
  ...
  static List<LotEQuest> get dailyDefaults {
    return [
      LotEQuest(
        ...
        questDescription:
            'A brisk walk or run to clear out stray energy beasts. Requires 15 mins of activity.',
      ...
      LotEQuest(
        ...
        questDescription:
            'Lift heavy weights, do bodyweight exercises, or strength training. Perform 20 mins.',
      ...
      LotEQuest(
        ...
        questDescription:
            'Perform a mobility routine, stretching, or yoga to improve flexibility. 15 mins.',
      ...
      LotEQuest(
        ...
        questDescription:
            'Log a protein-rich, nourishing meal with fresh vegetables and clean energy.',
...
List<LotEQuest> generateQuests(
  ...
  final List<String> themeWords = (() {
    switch (element) {
      ...
      case "Gas":
        return ["Vapor", "Aerosol", "Fume", "Mist", "Fog", "Haze", "Gaseous"];
      case "Laser":
        return ["Beam", "Photon", "Arc", "Reactor", "Focus", "Ray", "Laser"];
      case "Zero Space":
        return [
          "Void",
          "Cosmic",
  ...
  if (cadence == QuestCadence.daily) {
    ...
    for (int i = 0; i < min(4, uniqueFocuses.length); i++) {
      ...
      switch (focus) {
        ...
        case TrainingFocus.flexibility:
          ...
          title = titles[i % titles.length];
          desc =
              "Perform a flexibility, yoga, or dynamic mobility routine. Complete 15 minutes.";
        ...
        case TrainingFocus.cutting:
          ...
          title = titles[i % titles.length];
          desc =
              "Log a high-protein, calorie-deficit meal to burn off excess fat.";
    ...
    for (int i = 0; i < 2; i++) {
      ...
      switch (focus) {
        case TrainingFocus.calisthenics:
          final titles = [
            "$adjective Bar Mastery Campaign",
            "Sovereign $adjective Calisthenics Master",
          ];
          title = titles[i % titles.length];
          desc =
              "Complete 10 calisthenics sessions (handstands, pullups) this month.";
          wType = WorkoutCategory.strength;
        ...
        case TrainingFocus.lifting:
          final titles = [
            "$adjective Iron Forge Campaign",
            "Titan $adjective Weight Ascendance",
          ];
          title = titles[i % titles.length];
          desc =
              "Complete 10 heavy lifting sessions (squats, deadlifts) this month.";
          wType = WorkoutCategory.strength;
          stat = StatType.strength;
          target = 10;
          break;
        case TrainingFocus.cardio:
          final titles = [
            "$adjective Marathon Crusade",
            "$adjective Swiftness Road Campaign",
          ];
          title = titles[i % titles.length];
        ...
        case TrainingFocus.flexibility:
          final titles = [
            "$adjective Meridian Alignment",
            "$adjective Joint Elasticity Campaign",
          ];
          title = titles[i % titles.length];
          desc =
              "Complete 8 dynamic flexibility or stretching routines this month.";
          wType = WorkoutCategory.flexibility;
        ...
        case TrainingFocus.bulking:
          final titles = [
            "$adjective Metabolic Balance",
            "Pure $adjective Rations Crusade",
          ];
          title = titles[i % titles.length];
    ...
    switch (focus) {
      ...
      case TrainingFocus.bulking:
        ...
        desc =
            "Reach and sustain your target weight goals. Log 100 healthy meals.";
        wType = WorkoutCategory.nutrition;
        target = 100;
        break;
    }
...
class SuggestedWorkout {
  ...
  static List<SuggestedWorkout> get allWorkouts => [
    SuggestedWorkout(
      ...
      description:
          "Build upper body pushing strength targeting the chest using knees to reduce load.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Classic chest and triceps builder that challenges core stability.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Close-grip pushup variation designed to shift the load onto the inner chest and triceps.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Advanced single-arm loaded pushup variation sliding side-to-side.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "The ultimate pushup challenge, loading your entire chest unilaterally.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Safe chest builder that limits range of motion using the floor as a depth stop.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Classic dumbbell chest exercise that allows for deep contraction.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Isolation movement targeting upper chest fibers and shoulder stability.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Heavy overload press targeting mid-range chest drive and tricep lockout.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "High-intensity isometric squeeze press that triggers maximum chest recruitment.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Pull-up Bar",
      description:
          "Advanced bar dip focusing on deep chest stretch and lockout strength.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Pull-up Bar",
      description:
          "Peak vertical transition loading chest under extreme angles.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Controlled chest isolation using cable tension for continuous recruitment.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "The gold standard chest exercise for total upper body push power.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Barbell press targeting clavicular chest fibers for upper chest thickness.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Weighted vertical dips targeting lower chest sweep and tricep power.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Lie face down and raise chest to target lats and lower back muscles.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Use a sturdy horizontal bar or edge to pull bodyweight horizontally.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Unilateral pulling drill using door frame to build latch control.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Build extreme grip and forearm endurance using hanging towels.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Peak horizontal-to-vertical pulling combo targeting lats and core.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Core stability and back row combined in high plank position.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Heavy unilateral back overload targeting lat and rear delt.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Peak load pulling workout designed to overload lat thickness.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Pull-up Bar",
      description:
          "Activate shoulder blades and decompress spine from dead hang.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Pull-up Bar",
      description:
          "Build eccentric pull capacity by resisting gravity on descent.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Pull-up Bar",
      description:
          "Absolute peak of pulling strength, pulling entire body weight unilaterally.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Overload deltoids in seated position without leg assistance.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Maximum overload overhead press utilizing explosive leg power.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Target long head of triceps from overhead stretch position.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Overload biceps using curved EZ barbell to reduce wrist strain.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Dumbbells",
      description:
          "Brace core in high plank while dragging weight side-to-side.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Single leg squat requiring balance, mobility, and strength.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Full Gym",
      description:
          "Quad-dominant squatting variant holding bar on collarbones.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Flow between high plank and downward dog for full body mobility.",
      instructions: [
    ...
    SuggestedWorkout(
      ...
      equipment: "Bodyweight Only",
      description:
          "Multijoint mobility drill loading chest, hips, and shoulders.",
      instructions: [
