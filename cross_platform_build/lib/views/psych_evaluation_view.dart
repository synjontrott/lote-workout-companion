...
class _PsychEvaluationViewState extends State<PsychEvaluationView> {
              ...
              child: ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    if (_currentMindsetQuizQuestionIdx <
                        _mindsetQuizQuestions.length - 1) {
  ...
  static final List<QuizQuestion> _mindsetQuizQuestions = [
    QuizQuestion(
      ...
      options: [
        QuizOption(
          text: "I crave novelty and get bored easily without variety.",
          elementIndex: 0,
        ),
        QuizOption(
          text: "I need strict structure, clear rules, and predictability.",
          elementIndex: 1,
        ),
        QuizOption(
          text:
              "I need structure to function, but resent being forced into it.",
          elementIndex: 2,
        ),
        QuizOption(
          text: "I like building habits step-by-step and sticking to them.",
          elementIndex: 3,
        ),
      ],
    ),
    QuizQuestion(
      ...
      options: [
        QuizOption(
          text: "Instant gratification, quick challenges, and gamified loot.",
          elementIndex: 0,
        ),
        QuizOption(
          text: "Seeing detailed analytics, charts, and checking off boxes.",
          elementIndex: 1,
        ),
        QuizOption(
          text:
              "Having a solid plan, but with flexible choices so I don't feel trapped.",
          elementIndex: 2,
        ),
        QuizOption(
          text:
              "Seeing a long streak build up and hitting long-term milestones.",
          elementIndex: 3,
        ),
      ],
    ),
    QuizQuestion(
      ...
      options: [
        QuizOption(
          text:
              "Get distracted and skip it unless it sounds exciting right now.",
          elementIndex: 0,
        ),
        QuizOption(
          text: "Do it anyway because it's on the schedule, even if I hate it.",
          elementIndex: 1,
        ),
        QuizOption(
          text:
              "Experience intense demand avoidance and need an alternative option.",
          elementIndex: 2,
        ),
        QuizOption(
          text: "Rely on my discipline and habit loops to get through it.",
          elementIndex: 3,
        ),
      ],
    ),
