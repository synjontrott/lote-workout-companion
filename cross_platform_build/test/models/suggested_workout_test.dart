...
/// complete, unique 160-workout matrix
/// (8 muscle groups x 5 difficulties x 4 equipment types).
void main() {
  ...
  group('SuggestedWorkout.allWorkouts matrix', () {
    ...
    test('contains the full 160-workout combination matrix', () {
      expect(MuscleGroup.values.length, 8);
