...
This repository contains the Legends of the Elsaither Workout Companion in SwiftUI and Flutter. When working here, my purpose is to check that the code is clean, reliable, and aligned with `GEMINI.md`.
